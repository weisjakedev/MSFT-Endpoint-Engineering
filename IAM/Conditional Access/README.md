...
Excluding a trusted-ip on it's own can be risky. Lateral movement can occur and an attacker can escalate their privileges to get more sensitive information. I do not solely exclude a trusted location; I require device compliance policies in intune and require approval from security admin to elevate privileges. To see THOSE configs, please reference 
