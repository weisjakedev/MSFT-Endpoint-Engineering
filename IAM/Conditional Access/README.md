...
The Conditional Access model consists of 4 policies:
...
Upon successful authentication, access and refresh tokens are issued. On Entra-joined devices, a primary refresh token (PRT) enables single sign on (SSO) across Microsoft services for the duration of the session.
